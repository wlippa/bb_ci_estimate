...
# Copy allele count files to output directory (the script expects them in the working dir)
cp "${MOCK_DATA_DIR}"/tumour_alleleFrequencies_chr*.txt "${OUTPUT_DIR}/"
cp "${MOCK_DATA_DIR}"/normal_alleleFrequencies_chr*.txt "${OUTPUT_DIR}/"
